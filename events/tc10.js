...
if(!interaction.isButton() && !interaction.isSelectMenu()) return;
      ...
      if(interaction.customId == `create_ticket${s}`) {
        ...
        .addComponents([
         ...
         await interaction.reply({ content: `<a:loading_:906786750494564353> **Creazione del tuo ticket (potrebbe richiedere alcuni secondi)...**`, ephemeral: true })
        interaction.guild.channels.create(`${tcname || `ticket-${interaction.user.username}`}`, {
          ...
          interaction.editReply({ content: `${client.emoji.wrong} **Si è verificato un errore durante la creazione del ticket!**\n> *ErrCode: \`hHa_8\`*`, components: [reasons], ephemeral: true })
        ...
        .setAuthor(`Ticket per: ${interaction.user.tag}`, interaction.user.displayAvatarURL(), `https://discord.gg/estonija/`)
